...
export default function Projects() {
  ...
  const projectsList: Project[] = [
    {
      title: "Retro Synthwave Audio Engine",
      category: "CREATIVE ENGINEERING",
      image: "linear-gradient(135deg, #ff007f 0%, #9d4edd 100%)",
      description: "A lightweight, browser-synthesized audio canvas generating warm low-pass sweeps and slow pentatonic notes in real-time.",
      longDescription: "This engine utilizes the native HTML5 Web Audio API to compile modular analog synth oscillators, filter sweep nodes, and feedback loops directly in the browser with absolute zero weight. Featuring a dynamic canvas visualizer and real-time BPM/detuning adjusters.",
      tags: ["Next.js", "Web Audio API", "Three.js", "TypeScript"],
    ...
    {
      title: "CNN Image Prediction Pipeline",
      category: "MACHINE LEARNING",
      image: "linear-gradient(135deg, #00f5d4 0%, #00b4d8 100%)",
      description: "An accelerated deep learning classifier predicting visual features in under 12ms using optimized ONNX runtimes.",
      longDescription: "Built with PyTorch, this pipeline classifies high-resolution imagery and serves predictions through highly-efficient FastAPI endpoints. The models are compiled into ONNX binaries and served via lightweight Docker container setups deployed on AWS.",
      tags: ["PyTorch", "FastAPI", "ONNX", "Docker", "AWS"],
      github: "https://github.com/tannistha12/tans-portfolio",
      demo: "#",
    ...
    },
    {
      ...
      category: "AI TOOLING & AGENTS",
      image: "linear-gradient(135deg, #ff7b00 0%, #ff007f 100%)",
      description: "An interactive, agentic coding assistant optimizing local folders, tracking checklists, and correcting code errors.",
      longDescription: "A powerful dev companion engine integrating natural language analysis models to execute diagnostics, run compiler commands, compile structural schemas, and modify project codes seamlessly under complete developer sandboxing constraints.",
      tags: ["Node.js", "Gemini APIs", "TypeScript", "Tailwind"],
      github: "https://github.com/tannistha12/tans-portfolio",
      demo: "#",
              ...
              <div className="p-6 flex-1 flex flex-col gap-4 bg-black/80">
                ...
                <div className="border-t border-white/10 pt-4 flex items-center justify-between">
                  ...
                  <div className="flex items-center gap-3">
                    ...
                    <a
                      href={project.demo}
                      className="text-muted hover:text-white transition-all interactive-cursor"
